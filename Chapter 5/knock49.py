"""
knock49.py: トークン化 (Tokenization)

与えられたテキストを実際にトークン化し、トークン数と
トークンIDを確認します。
"""
...
def get_encoding(model):
    """Return a tokenizer encoding for the configured setting."""
...
def count_tokens():
    """Tokenize text and print tokenization details."""
